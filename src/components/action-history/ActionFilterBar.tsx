  ...
  return <div className="bg-card rounded-xl border border-border p-4 space-y-4">
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={filters.deviceType} onValueChange={value => onFilterChange({
          deviceType: value as DeviceType | "all"
            ...
            <SelectContent className="bg-popover border border-border shadow-lg z-50">
              {deviceTypeOptions.map(option => <SelectItem key={option.value} value={option.value}>
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={filters.sortOrder} onValueChange={value => onFilterChange({
